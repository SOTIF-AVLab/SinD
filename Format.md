...
<img src="Ground Coordinate System and Traffic Light Distribution.png" width = 800 >  
...
***
In addition to the record file, we also provide a [high-definition map](mapfile.osm#sdd) of the intersection in [Lanelet2](https://github.com/fzi-forschungszentrum-informatik/Lanelet2) format, the origin of the map coincides with the origin of the ground coordinate system.
