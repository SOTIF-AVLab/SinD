...
_MPL_CONFIG_DIR = Path(mpl.get_configdir()).expanduser()
_MPL_STYLE_DIR = _MPL_CONFIG_DIR / "stylelib"
_MPL_STYLE_ALIAS = _MPL_STYLE_DIR / "seaborn-whitegrid.mplstyle"
if not _MPL_STYLE_ALIAS.exists():
    _MPL_STYLE_DIR.mkdir(parents=True, exist_ok=True)
    _MPL_STYLE_ALIAS.write_text("axes.grid: True\n")
