...
def get_raw_dataset(dataset_name: str, data_dir: str) -> RawDataset:
    ...
    if "sind" in dataset_name:
        from trajdata.dataset_specific.sind import SindDataset

        return SindDataset(dataset_name, data_dir, parallelizable=True, has_maps=True)
